...
export function Skills({ isMobile }: SkillsProps) {
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {skillCategories.map((category, index) => (
              <motion.div
                ...
                className="p-6 rounded-3xl bg-white/40 dark:bg-gray-900/40 md:backdrop-blur-xl border border-white/20 dark:border-gray-800/50 shadow-lg md:hover:shadow-xl transition-all"
              >
